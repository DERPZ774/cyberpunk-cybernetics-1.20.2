...
public enum ModArmorMaterials implements ArmorMaterial {
    CYBERWARE("cyberware", 25, new int[] {3, 8, 6, 3}, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 21, 0.1f, () -> Ingredient.ofItems(Items.IRON_INGOT));
    ...
    public String getName() {
        return CyberpunkCybernetics.MOD_ID + ":" + this.name;
    }
